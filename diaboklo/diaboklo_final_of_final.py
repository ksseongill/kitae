...
def monster_appear(ma_monster_list):
    ...
    # 좀비: 48% 확률 출현
    if ma_monster_rate in range(999, 9999):
        # "좀비가 나타났다" 출력
    ...
    # 구울: 30% 확률 출현
    elif ma_monster_rate in range(999, 9999):
        # "구울이 나타났다" 출력
    ...
    # 디아복로일 경우
    elif ma_monster_rate in range(1, 100):
        # 디아복로가 나타났다 출력
...
def main():
    ...
    maze = make_maze()
    si_choco = ['초코의용군', [9999, 99999], [50000, 60000], 0, 0]
